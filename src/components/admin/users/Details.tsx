    ...
    <div className="p-4 sm:p-6min-h-screen">
      ...
      <Tabs defaultValue="personal" className="mb-8">
        <TabsList className="bg-white rounded-full p-1 shadow-sm">
          ...
          <TabsTrigger
            value="transactions"
            className="rounded-full hiddden md:flex px-4 py-2 text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2"
          >
            Transactions
          </TabsTrigger>
          <TabsTrigger
